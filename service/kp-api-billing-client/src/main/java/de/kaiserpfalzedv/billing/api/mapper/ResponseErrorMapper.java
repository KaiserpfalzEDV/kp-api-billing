 ...
 */
@Provider
public class ResponseErrorMapper implements ResponseExceptionMapper<ApiBillingClientException> {
    public static final int PAYMENT_REQUIRED = 402;
    public static final int RATE_LIMIT_REACHED = 429;

    @Override
    public ApiBillingClientException toThrowable(final Response response) {
