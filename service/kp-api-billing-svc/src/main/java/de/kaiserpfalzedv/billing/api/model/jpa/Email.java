...
/**
 * <p>Email -- The JPA implementation for {@link de.kaiserpfalzedv.billing.api.api.Email}</p>
 *
...
public class Email implements de.kaiserpfalzedv.billing.api.api.Email {
    @Schema(
            title = "LocalPart",
