...
/**
 * <p>User -- The JPA implementation for {@link de.kaiserpfalzedv.billing.api.model.User}.</p>
 *
...
public class User extends BaseNamedResource implements de.kaiserpfalzedv.billing.api.model.User {
    @Embedded
    @NotNull
    private Email email;
